...
class Rworthiness extends StatefulWidget {
  const Rworthiness({super.key});

  @override
  State<StatefulWidget> createState() => _Rworthiness();
}

class _Rworthiness extends State<Rworthiness> {
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            children: [
              ...
              TextFormField(
                inputFormatters: [FilteringTextInputFormatter.allow(RegExp('[a-zA-Z0-9]')),LengthLimitingTextInputFormatter(9)],
                controller: plateNo,
                ...
                children: [
                  ...
                  responseData.plateNumber != null && !isloading
                      ...
                      : isloading
                          ...
                          : isError ? const Text("Invalid Plate number")
                          : const Text("Enter Plate Number in the field above")
                ],
              ),
            ],
          ),
